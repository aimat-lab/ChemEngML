c ***********************************************************************
c
c $HeadURL: svn://129.13.162.100/simson/blaq/nonlinbl.f $
c $LastChangedDate: 2016-01-11 13:59:03 +0100 (Mon, 11. Jan 2016) $
c $LastChangedBy: alex $
c $LastChangedRevision: 85 $
c
c ***********************************************************************
     ...
     &     tempr,tempi,aaar,aaai,rgh_h,rgh_ampl,rgh_maxyn,rgh_hy,
...
C     Roughness with direct forcing (loctyp==9)
...
C                     th2r(xy,z,4+4*(ith-1)) = -h1u + u2r(xy,z,1)
C                     th2i(xy,z,4+4*(ith-1)) = -h2u + u2i(xy,z,1)
