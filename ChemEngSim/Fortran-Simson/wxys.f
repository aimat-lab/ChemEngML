c ***********************************************************************
c
c $HeadURL: svn://129.13.162.100/simson/blaq/wxys.f $
...
c
      ...
      real mhd_n,b0(3)
c
c     runtime plane statistics ***Pourya***
c
      real plxys(nx,nyp/nprocz+1,nzstat0,npls)
      real wplxy(nx,nyp)
      integer nzstat,is,jp
      character*80 namzstat
c
...
#ifdef MPI
      real txys(nx),temp(nx),tplxys(nx)
